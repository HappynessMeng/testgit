...
<span class="layui-breadcrumb" lay-separator=">" >
    ...
    <a href="">{$sys.name}</a>
    <a href="{:U('index','',false)}/systemid/{$Think.get.systemid}">用户管理(用户资料修改)</a>
</span>
</div>
...
<div class="main_cont" style="width:65%;">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input name="ismulti" lay-skin="switch" value="1" lay-text="启用|禁用" type="checkbox" <?php if($uinfo['ismulti'] == '1' ) echo 'checked'; ?> >
        </div>
    </div>
    ...
    <div class="layui-input-block">
        <input name="isenable" lay-skin="switch" value="1" lay-text="启用|禁用" type="checkbox"  <?php if($uinfo['isenable'] == '1' ) echo 'checked'; ?>>
	</div>
  </div>
  
   <?php if(empty($roledata) || $uinfo['sulevel'] ==2 ):?>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
       <div>
          ...
          <input type="checkbox" name="roleids[]" value="{$v.id}" title="{$v.rolename}" <?php echo in_array($v['id'],$ckrole) ? 'checked' : '' ?>>
          <?php endforeach;?>
  ...
  <input type="hidden" name="sulevel"  value="{$uinfo.sulevel}" />
