...
<form action="" method="post" name="frmsys" class="layui-form ">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input name="name" type="text" class="layui-input" id="name" maxlength="50" lay-verify="required"  placeholder="请输入权限名称" autocomplete="off">  
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">权值</label>
    <div class="layui-input-block">
      <input name="value" type="text" class="layui-input" maxlength="50" lay-verify="required" placeholder="请输入权值信息" autocomplete="off">  
    </div>
  </div>
    ...
    <div class="layui-input-block" style="width:50px;">
      <input name="sort" type="text" class="layui-input" id="sort" value="50" maxlength="2" lay-verify="required|number" autocomplete="off" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" >
      <input type="hidden" name="pid" value="{$Think.get.noteid}" >
