          ...
          <div style="max-width:400px;margin:10px 0 0 0" class="layui-tab-item layui-show">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input name="rolename" type="text" class="layui-input" id="rolename" maxlength="50" lay-verify="required" value="{$data.rolename}" autocomplete="off">  
                    </div>
                  </div>  
                    <div class="layui-form-item">
                    <label class="layui-form-label">角色描述</label>
                    <div class="layui-input-block">
                    <textarea name="description" class="layui-textarea" lay-verify="required" >{$data.description}</textarea>
                    <input type="hidden" name="id" value="{$Think.get.roleid}" >
                  ...
                  <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                        <input type="checkbox" name="isdefault" title="默 认" value="1"  <?php echo $data['isdefault'] ? 'checked' : '' ;?>>
                        </div>
                  </div>
        </div>
    	<!--Role Info End-->
...
var zNodes =[
	...
	{ id:{$v.id}, pId:{$v.pid}, name:"{$v.name}", open:<?php echo $v['_level']>2 ? 'false' : 'true' ;?> <?php echo in_array($v['id'],$benodes) ? ' , checked:true' : '' ?>},
	<?php endforeach;?>
];
